...
import { Customer, CollectorActivity, CollectorProfile } from "./types";
...
export const sampleDatasets: DatasetSample[] = [
  {
    ...
    // Let's create realistic activities
    // KOL-01 is extremely close to customer (-8.6738, 115.2091)
    // 1 km is roughly 0.009 degrees of latitude/longitude.
    activities: [
      // KOL-01 - 12 activities, mostly within 0.8 km (high frequency, high consistency, high confidence)
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Kunjungan rumah & penagihan rutin",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Penagihan berhasil dan update database",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Penyerahan surat peringatan pertama",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Kunjungan follow-up bulanan",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Koleksi cicilan triwulan",
      },
      {
        collector_code: "KOL-01",
        ...
        longitude: 115.2090,
        transaction_amount: 500000,
        activity_description: "Penagihan reguler",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Distribusi brosur & tagihan",
      },
      {
        collector_code: "KOL-01",
        ...
        latitude: -8.6720,
        longitude: 115.2075,
        transaction_amount: 1100000,
        activity_description: "Penagihan berhasil",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Verifikasi tempat tinggal nasabah harian",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Kunjungan & janji bayar",
      },
      {
        collector_code: "KOL-01",
        ...
        activity_description: "Penagihan rutin tengah bulan",
      },
      {
        collector_code: "KOL-01",
        ...
        longitude: 115.2092,
        transaction_amount: 500000,
        activity_description: "Penagihan rutin awal bulan",
      },

      // KOL-02 - moderate proximity (mostly Kuta / Imam Bonjol, 2.5 km away)
      // Only 5 activities in radius (secondary range), higher workload (48 active customers)
      {
        collector_code: "KOL-02",
        ...
        activity_description: "Kunjungan Imam Bonjol",
      },
      {
        collector_code: "KOL-02",
        ...
        longitude: 115.1955,
        transaction_amount: 1500000,
        activity_description: "Kunjungan rute simpang siur",
      },
      {
        collector_code: "KOL-02",
        ...
        longitude: 115.1930,
        transaction_amount: 1200000,
        activity_description: "Verifikasi nasabah Kuta utara",
      },
      {
        collector_code: "KOL-02",
        ...
        activity_description: "Penagihan borongan merchant",
      },

      // KOL-03 - low activities in area (only 1 point inside, others > 5 km)
      {
        collector_code: "KOL-03",
        activity_date: "2026-06-10",
        latitude: -8.6750,
        longitude: 115.2090, // very close (0.1km), but only this one!
        transaction_amount: 400000,
        activity_description: "Kunjungan darurat",
      },
      {
        collector_code: "KOL-03",
        activity_date: "2026-06-01",
        latitude: -8.6120, // far away
        longitude: 115.2320,
        transaction_amount: 1200000,
        activity_description: "Kunjungan Sanur jauh",
      },
    ],
  },
  {
    ...
    profiles: [
      ...
      },
      {
        ...
        active_days: 20,
        active_customers: 40, // very overloaded
        average_daily_activity: 4.5,
      },
    ],
    activities: [
      // KOL-02 activities centered around RT Menteng/Gondangdia (very close < 1km)
      {
        collector_code: "KOL-02",
        ...
        activity_description: "Penagihan korporat Menteng",
      },
      {
        collector_code: "KOL-02",
        activity_date: "2026-06-15",
        ...
        activity_description: "Kunjungan rutin Cikini",
      },
      {
        collector_code: "KOL-02",
        activity_date: "2026-06-10",
        ...
        activity_description: "Janji bayar jatuh tempo",
      },
      {
        collector_code: "KOL-02",
        ...
        activity_description: "Distribusi surat penagihan",
      },
      {
        collector_code: "KOL-02",
        ...
        longitude: 106.8318,
        transaction_amount: 3200000,
        activity_description: "Follow up lanjutan",
      },
      {
        collector_code: "KOL-02",
        ...
        activity_description: "Kunjungan mingguan rutin",
      },
      {
        collector_code: "KOL-02",
        activity_date: "2026-05-12",
        ...
        longitude: 106.8310,
        transaction_amount: 2500000,
        activity_description: "Koleksi cicilan",
      },
      {
        collector_code: "KOL-02",
        ...
        latitude: -6.1890,
        longitude: 106.8325,
        transaction_amount: 4700000,
        activity_description: "Penagihan lancar",
      },
      {
        collector_code: "KOL-02",
        ...
        longitude: 106.8322,
        transaction_amount: 1500000,
        activity_description: "Janji bayar Menteng",
      },
      {
        collector_code: "KOL-02",
        ...
        longitude: 106.8329,
        transaction_amount: 3000000,
        activity_description: "Penagihan rutin",
      },
      {
        collector_code: "KOL-02",
        ...
        longitude: 106.8332,
        transaction_amount: 4000000,
        activity_description: "Kunjungan mingguan awal",
      },

      // KOL-01 activities in secondary range (Cideng / Thamrin, 2km - 3km)
      {
        collector_code: "KOL-01",
        activity_date: "2026-06-18",
        latitude: -6.2081,
        longitude: 106.8210,
        transaction_amount: 1500000,
        activity_description: "Kunjungan Thamrin",
      },
      {
        collector_code: "KOL-01",
        activity_date: "2026-06-10",
        ...
        activity_description: "Penagihan gedung Sudirman",
      },
      {
        collector_code: "KOL-01",
        ...
        latitude: -6.2070,
        longitude: 106.8220,
        transaction_amount: 2200000,
        activity_description: "Kunjungan reguler Sudirman",
      },
    ],
  },
  {
    ...
    activities: [
      // All activities are very far (e.g. in Tabanan kota / Denpasar, > 35km away)
      {
        collector_code: "KOL-01",
        activity_date: "2026-06-18",
        latitude: -8.5450, // ~30km away south
        longitude: 115.1200,
        transaction_amount: 800000,
        activity_description: "Kunjungan Tabanan Kota",
      },
      {
        collector_code: "KOL-02",
        activity_date: "2026-06-15",
        latitude: -8.6738, // ~45km away Denpasar
        longitude: 115.2091,
        transaction_amount: 1500000,
        activity_description: "Penagihan Denpasar",
      },
      {
        collector_code: "KOL-03",
        activity_date: "2026-06-17",
        latitude: -8.4500, // ~20km away south
        longitude: 115.1300,
        transaction_amount: 300000,
        activity_description: "Aktivitas Baturiti selatan",
      },
    ],
  },
];
